...
Begin VB.Form frmGIFDisLocalizacaCaixa 
   ...
   Begin vsOcx6LibCtl.vsIndexTab Vst_Pallet 
      ...
      Begin vsOcx6LibCtl.vsElastic vsElastic2 
         ...
         Begin VB.CommandButton cmd_impresao 
            ...
            Height          =   555
            Left            =   10410
            Picture         =   "frmGIFDisLocalizacaCaixa.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   90
            Width           =   795
      ...
      Begin vsOcx6LibCtl.vsElastic vsElastic1 
         ...
         Begin VB.Frame frm_pesquisa_peca 
            ...
            Visible         =   0   'False
            Width           =   5655
            Begin VB.CommandButton cmd_Incluir_caixa 
               BackColor       =   &H00C0FFC0&
               Caption         =   ">"
               Height          =   345
               Left            =   2610
            ...
            Begin VB.CommandButton cmd_cancelar 
               ...
               Height          =   555
               Left            =   3210
               Picture         =   "frmGIFDisLocalizacaCaixa.frx":0532
               Style           =   1  'Graphical
               TabIndex        =   46
            ...
            Begin VB.CommandButton cmd_confirmar 
               ...
               Height          =   555
               Left            =   4710
               Picture         =   "frmGIFDisLocalizacaCaixa.frx":083C
               Style           =   1  'Graphical
               TabIndex        =   45
               ToolTipText     =   "Confirme seleção de caixas"
               Top             =   2220
               Width           =   675
            End
         ...
         Begin VB.CommandButton cmd_imprime_pallet 
            ...
            Height          =   405
            Left            =   10770
            Picture         =   "frmGIFDisLocalizacaCaixa.frx":0B46
            Style           =   1  'Graphical
            TabIndex        =   42
         ...
         Begin VB.CommandButton CMD_TODOS 
            ...
            Height          =   405
            Left            =   10770
            Picture         =   "frmGIFDisLocalizacaCaixa.frx":1078
            Style           =   1  'Graphical
            TabIndex        =   40
            ToolTipText     =   "Imprime todas as caixas no intervalo"
            Top             =   1590
            Width           =   525
         End
         Begin VB.Frame Frame3 
            ...
            Top             =   60
            Width           =   10245
            Begin VB.CommandButton CMD_PESQUISAR_CAIXAS 
               BackColor       =   &H00C0FFC0&
   ...
   End
End
Attribute VB_Name = "frmGIFDisLocalizacaCaixa"
...
Me.CMD_PESQUISAR_CAIXAS.BackColor = &HFF&
...
If Me.lst_selecionadas.ListCount > 0 Then
   Me.CMD_PESQUISAR_CAIXAS.BackColor = &HC000&
Else
   Me.CMD_PESQUISAR_CAIXAS.BackColor = &HFF&
End If
Me.frm_pesquisa_peca.Visible = False
...
Private Sub cmd_Incluir_caixa_Click()
...
Rem verificar se houve selecao de caixas
...
Set cRec = CCTemp.EXPEDICAO_Consultar_caixa(sNomeBanco, _
...
Private Sub CMD_PESQUISAR_CAIXAS_Click()
Me.frm_pesquisa_peca.Visible = True
Me.txt_acha_peca.SetFocus
...
If Len(Trim(Me.txt_acha_peca.Text)) = 0 Then
   ...
   Exit Function
Else
   scaixa = Format(Trim(Me.txt_acha_peca.Text), "0000000000")
End If
...
Me.MousePointer = vbHourglass
Set cRec = CCTemp.EXPEDICAO_Consultar_Uma_Caixa(sNomeBanco, scaixa, sCliente)

If cRec.RecordCount > 0 Then
   cRec.MoveFirst
   For nx = 0 To Me.lst_selecionadas.ListCount - 1
       If Me.lst_selecionadas.List(nx) = Me.txt_acha_peca.Text Then
          MsgBox "Caixa ja selecionada, Digite outra se necessário!"
          Me.MousePointer = vbDefault
          Me.txt_acha_peca.Text = ""
          Me.txt_acha_peca.SetFocus
          Exit Function
       End If
   Next
   Me.lst_selecionadas.AddItem scaixa
Else
...
CrystalReport1.ParameterFields(1).AddCurrentValue " Todas as caixas."
CrystalReport1.ParameterFields(1).DiscreteOrRangeKind = crDiscreteValue
...
mfl_grid.Col = 1: If Len(Trim(mfl_grid.Text)) = 0 Then Exit Function
...
Set cRec = CCTemp.EXPEDICAO_Consultar_Pallet_Caixa(sNomeBanco, _
                                                   Format(Trim(Me.TXT_CX1.Text), "0000000000"), _
                                                   Format(Trim(Me.TXT_CX2.Text), "0000000000"), _
...
If Not Testa_Numerico(Me.txt_acha_peca.Text, Len(Me.txt_acha_peca.Text)) Then
   MsgBox "Só aceita numeros, redigite"
   Me.txt_acha_peca.Text = Mid$(Me.txt_acha_peca.Text, 1, Len(Trim(Me.txt_acha_peca.Text)) - 1)
   Me.txt_acha_peca.SetFocus
   SendKeys "{END}"
End If
