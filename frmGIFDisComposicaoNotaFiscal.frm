...
Begin VB.Form frmGIFDisComposicaoNotaFiscal 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Composção de Nota Fiscal"
   ClientHeight    =   6405
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11685
   ...
   Begin vsOcx6LibCtl.vsIndexTab Vst_Pallet 
      ...
      Begin vsOcx6LibCtl.vsElastic vsElastic2 
         ...
         Begin VB.CommandButton cmd_impresao 
            ...
            Height          =   555
            Left            =   10410
            Picture         =   "frmGIFDisComposicaoNotaFiscal.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   90
            Width           =   795
      ...
      Begin vsOcx6LibCtl.vsElastic vsElastic1 
         ...
         Begin VB.CommandButton cmd_imprime_pallet 
            ...
            Height          =   465
            Left            =   10680
            Picture         =   "frmGIFDisComposicaoNotaFiscal.frx":0532
            Style           =   1  'Graphical
            TabIndex        =   47
   ...
   End
End
Attribute VB_Name = "frmGIFDisComposicaoNotaFiscal"
...
Set cRec = CCTemp.EXPEDICAO_Consultar_Comp_NF(sNomeBanco, _
                                              sDataINI, _
                                              sDataFIM, _
                                              sSEQ1, _
                                              sSEQ2, _
                                              sStatus, _
                                              sCliente, _
                                              Trim(Me.TXT_CX1.Text), _
                                              Trim(Me.TXT_CX2.Text))
...
Set cRec = CCTemp.EXPEDICAO_Consultar_Pallet_Seq_NF(sNomeBanco, _
                                                    Trim(Me.TXT_CX1.Text), _
                                                    Trim(Me.TXT_CX2.Text), _
